...
function init() {
    //jQuery.ajax({
      //  type: "GET",
        //url: 'http://ec2-52-87-159-69.compute-1.amazonaws.com:8080/WHAM/datasource/37.3394444/-121.8938889/10',
        //dataType: "jsonp",
        //cache: false,
        //crossDomain: true,
        //processData: true,
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            $.get({ url: "http://ec2-52-87-159-69.compute-1.amazonaws.com:8080/WHAM/datasource/37.3394444/-121.8938889/10" }, function (data) {
                var loc = data;
